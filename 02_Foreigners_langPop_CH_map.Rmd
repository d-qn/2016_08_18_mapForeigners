...
for (lang in colnames(txt)) {
  ...
  map2 <- ggplot(co.df) + 
    ...
    ddd$tip <- paste0(
      '<b>', as.character(ddd$GEMNAME), '</b><br><hr>',
      'Etrangers <b>', ddd$pcForeigners * 100, '%</b><br>(',
      ifelse(ddd$deltaForeigners>0, "+", ""), ddd$deltaForeigners * 100, " point de pourcentage depuis 2010)",
      '<br>population: ', ddd$population
      )
